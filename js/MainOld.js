...
function initFirstPage(){
           ...
           btn1 = containerMC.addChild(new Button("next","", "#F00", "assets/arrow.png", 916,336,true,0, 91,109));
...
function initText(page){
	...
	TweenLite.from(squareHolder, .5, {alpha:0, delay:0});
////end white rect
